...
//    EmbeddedCuaDriverHost so TCC grants attribute to OpenGrokBot and the
//    driver inherits them. One prompt, named OpenGrokBot, out of the box.
...
const HOST_BUNDLE_ID = "com.opengrokbot.app";
